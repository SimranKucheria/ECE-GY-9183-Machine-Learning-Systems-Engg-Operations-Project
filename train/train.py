...
from train.utils import init_distributed_mode, get_rank, get_world_size, is_main_process
from train.utils import create_sampler, create_loader, create_dataset
from train.utils import save_result, coco_caption_eval
from train.utils import cosine_lr_schedule
from train.utils import train, evaluate
...
def train_model(args, config):
    ...
    mlflow.set_experiment(config.get('experiment_name', 'blip-captioning'))
    mlflow.start_run()
        ...
        if is_main_process():   
            ...
            if args.evaluate:            
                ...
                if current_score > best_score:
                    ...
                    if is_main_process():
                        logger.info(f"Best model saved and registered at epoch {epoch}")
